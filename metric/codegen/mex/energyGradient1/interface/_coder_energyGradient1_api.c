 ...
 *
 * _coder_energyGradient1_api.c
 *
 * Code generation for function '_coder_energyGradient1_api'
 *
 */
...
static emlrtRTEInfo eb_emlrtRTEI = {
    1,                            /* lineNo */
    1,                            /* colNo */
    "_coder_energyGradient1_api", /* fName */
    ""                            /* pName */
};
...
void energyGradient1_api(const mxArray *const prhs[7], const mxArray **plhs)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  energyGradient1(&st, *c, n, D, N, *T, *T_dot, *w, g);
...
/* End of code generation (_coder_energyGradient1_api.c) */
